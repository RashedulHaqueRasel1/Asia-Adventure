...
const Login = () => {
    ...
    const { singWithGoogle, singWithGithub } = useContext(AuthContext)
        ...
        <div>
            ...
            <div className="w-full card shrink-0 mt-12 mb-16  max-w-sm shadow-2xl bg-base-100   p-8 space-y-3 rounded-xl container mx-auto" style={{ boxShadow: 'rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px' }} data-aos="fade-up" data-aos-duration="2000">
                <label className="label ml-32">
                    <span className="label-text text-2xl font-bold ">Login</span>
                </label>
                ...
                <form className="space-y-6" onSubmit={handleSubmit(onSubmit)} >
                    <div className="space-y-1 text-sm" data-aos="fade-up" data-aos-duration="2200">
                        ...
                        <input type="text" name="email" id="email" placeholder="Your Email" className="input input-bordered w-full    border-blue-300   focus:dark:border-blue-500" {...register("email", { required: true })} />
